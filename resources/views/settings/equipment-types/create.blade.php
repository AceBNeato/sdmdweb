...
@section('title', 'Create Equipment Type - System Management')
@section('page_title', 'Create Equipment Type')
@section('page_description', 'Add a new equipment type')
            ...
            <div class="card">
                ...
                <div class="card-body">
                    <form action="{{ route('admin.settings.equipment-types.store') }}" method="POST">
                        ...
                        <div class="mb-3">
                            <label for="name" class="form-label">Equipment Type Name <span class="text-danger">*required</span></label>
