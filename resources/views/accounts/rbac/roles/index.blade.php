...
@section('page_description', 'Manage roles and permissions for all users')
...
<div class="rbac-permissions-container">
    ...
    <div class="d-flex justify-content-between align-items-center mb-4">
        <div>
            <h1 class="h2 mb-2">Role & Permission Management</h1>
            <p class="text-muted">Manage roles and permissions in one place</p>
        </div>
        <div>
                        ...
                        @foreach($roles as $role)
                            ...
                            <th class="role-column" data-role-id="{{ $role->id }}">
                                ...
                                <div class="d-flex justify-content-center align-items-center gap-2 mt-2">
                                    <a href="#" class="text-primary small role-select-all" style="cursor: pointer; text-decoration: none;">
                                        <i class="fas fa-check-square me-1"></i>Select All
                                    </a>
                                    @if(auth()->user()->hasPermissionTo('roles.edit'))
                                        <span class="text-muted small">|</span>
                                        <a href="{{ route('admin.rbac.roles.edit', $role) }}" class="text-secondary small" title="Edit Role" style="text-decoration: none;">
