...
@section('title', ($equipment->exists ? 'Edit' : 'Add') . ' Equipment - SDMD')
@section('breadcrumbs', 'App / ' . ($equipment->exists ? 'Edit Equipment' : 'Add Equipment'))
@section('page_title', $equipment->exists ? 'Edit Equipment' : 'Add New Equipment')
...
@push('styles')
    <style>
        ...
        @media (max-width: 768px) {
            ...
            /* Make button row stack vertically on mobile */
                            ...
                            <div class="field-container">
                                ...
                                <select class="form-select @error('category_id') is-invalid @enderror"
                                    ...
                                    @foreach($categories as $id => $name)
                                        <option value="{{ $id }}" {{ old('category_id', $equipment->category_id ?? '') == $id ? 'selected' : '' }}>
                                            {{ $name }}
                                        </option>
                                    @endforeach
                                </select>
